<?php
	...
	echo "<br>Query: ".$mysql_qry." + Error: ".mysqli_error($conn)."<br>";
	$mysql_qry = "insert into answers values('','$id_quest','$odp1','$popr1')";
	$result = mysqli_query( $conn,$mysql_qry);
	echo "<br>Query: ".$mysql_qry." + Error: ".mysqli_error($conn)."<br>";
	$mysql_qry = "insert into answers values('','$id_quest','$odp2','$popr2')";
	$result = mysqli_query( $conn,$mysql_qry);
	echo "<br>Query: ".$mysql_qry." + Error: ".mysqli_error($conn)."<br>";
	$mysql_qry = "insert into answers values('','$id_quest','$odp3','$popr3')";
	$result = mysqli_query( $conn,$mysql_qry);
	echo "<br>Query: ".$mysql_qry." + Error: ".mysqli_error($conn)."<br>";
	echo "<a href='question.php?id=".$id_kat."'>Powrot";
	?>